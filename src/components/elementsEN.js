module.exports = {
    ...
    elementsEN: [
        [{
            ...
            summary: 'O Hydro é um elemento químico que não possui família periódica, participa da composição de diversas substâncias e apresenta ampla utilização.',
            symbol: 'H',
            xpos: 1,
            ypos: 1,
            shells: [1]
        ...
        {
            name: 'Argônio',
            appearance:'gás incolor exhibiting',
            atomic_mass: 39.9481,
            boil: 87.302,
            category: 'noble gas',
            color: null,
